...
//
//	mockgen -source usecase.go -package mock_store -destination mocks/mocks.go -typed true
//
...
// Get mocks base method.
func (m *MockcontentRepository) Get(ctx context.Context, path string) (model.ReadSeekCloser, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *contentRepositoryGetCall) Return(arg0 model.ReadSeekCloser, arg1 error) *contentRepositoryGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *contentRepositoryGetCall) Do(f func(context.Context, string) (model.ReadSeekCloser, error)) *contentRepositoryGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *contentRepositoryGetCall) DoAndReturn(f func(context.Context, string) (model.ReadSeekCloser, error)) *contentRepositoryGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockfileRepository) GetFiles(ctx context.Context, txId string, filter model.FileFilter) ([]model.File, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFiles", ctx, txId, filter)
	ret0, _ := ret[0].([]model.File)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockfileRepositoryMockRecorder) GetFiles(ctx, txId, filter any) *fileRepositoryGetFilesCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFiles", reflect.TypeOf((*MockfileRepository)(nil).GetFiles), ctx, txId, filter)
	return &fileRepositoryGetFilesCall{Call: call}
}

// fileRepositoryGetFilesCall wrap *gomock.Call
type fileRepositoryGetFilesCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *fileRepositoryGetFilesCall) Return(arg0 []model.File, arg1 error) *fileRepositoryGetFilesCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *fileRepositoryGetFilesCall) Do(f func(context.Context, string, model.FileFilter) ([]model.File, error)) *fileRepositoryGetFilesCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *fileRepositoryGetFilesCall) DoAndReturn(f func(context.Context, string, model.FileFilter) ([]model.File, error)) *fileRepositoryGetFilesCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// MockcontentWriter is a mock of contentWriter interface.
type MockcontentWriter struct {
	ctrl     *gomock.Controller
	recorder *MockcontentWriterMockRecorder
}

// MockcontentWriterMockRecorder is the mock recorder for MockcontentWriter.
type MockcontentWriterMockRecorder struct {
	mock *MockcontentWriter
}

// NewMockcontentWriter creates a new mock instance.
func NewMockcontentWriter(ctrl *gomock.Controller) *MockcontentWriter {
	mock := &MockcontentWriter{ctrl: ctrl}
	mock.recorder = &MockcontentWriterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockcontentWriter) EXPECT() *MockcontentWriterMockRecorder {
	return m.recorder
}

// Write mocks base method.
func (m *MockcontentWriter) Write(ctx context.Context, path string, contents model.Contents) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Write", ctx, path, contents)
	ret0, _ := ret[0].(error)
	return ret0
}

// Write indicates an expected call of Write.
func (mr *MockcontentWriterMockRecorder) Write(ctx, path, contents any) *contentWriterWriteCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockcontentWriter)(nil).Write), ctx, path, contents)
	return &contentWriterWriteCall{Call: call}
}

// contentWriterWriteCall wrap *gomock.Call
type contentWriterWriteCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *contentWriterWriteCall) Return(err error) *contentWriterWriteCall {
	c.Call = c.Call.Return(err)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *contentWriterWriteCall) Do(f func(context.Context, string, model.Contents) error) *contentWriterWriteCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *contentWriterWriteCall) DoAndReturn(f func(context.Context, string, model.Contents) error) *contentWriterWriteCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
